...
from linear_reg_func import create_draw_network, split_create_data, converge2
from linear_reg_func import init_all_theta, compute_each_grad_one_theta, compute_each_grad, update_each_theta
